...
public class ATSixthPageGUIScreen extends AbstractContainerScreen<ATSixthPageGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.at_sixth_page_gui.label_plains"), 49, 75, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.at_sixth_page_gui.label_river"), 52, 92, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.at_sixth_page_gui.label_savanna"), 47, 110, -12829636);
	}
