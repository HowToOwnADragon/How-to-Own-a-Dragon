...
public class FemaleTTGUIScreen extends AbstractContainerScreen<FemaleTTGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.female_ttgui.label_healthvalue"), 31, 93, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.female_ttgui.label_armor"), 20, 108, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.female_ttgui.label_armorvalue"), 31, 118, -12829636);
