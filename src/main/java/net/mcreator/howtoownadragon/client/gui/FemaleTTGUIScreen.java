...
public class FemaleTTGUIScreen extends AbstractContainerScreen<FemaleTTGUIMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 118, this.topPos + 4, 0, 0, 11, 12, 11, 12);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.female_ttgui.label_male_gronckle"), 4, 5, -13421773);
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.female_ttgui.label_inventory"), 7, 70, -13421773);
	}
