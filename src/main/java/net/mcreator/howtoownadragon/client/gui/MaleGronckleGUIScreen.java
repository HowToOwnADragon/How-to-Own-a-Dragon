...
public class MaleGronckleGUIScreen extends AbstractContainerScreen<MaleGronckleGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.male_gronckle_gui.label_health"), 8, 100, -12829636);
		...
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.male_gronckle_gui.label_damagevalue"), 30, 159, -12829636);
		...
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.male_gronckle_gui.label_walkspeedvalue"), 248, 111, -12829636);
		...
		this.font.draw(poseStack, Component.translatable("gui.how_to_own_a_dragon.male_gronckle_gui.label_flyspeedvalue"), 248, 136, -12829636);
