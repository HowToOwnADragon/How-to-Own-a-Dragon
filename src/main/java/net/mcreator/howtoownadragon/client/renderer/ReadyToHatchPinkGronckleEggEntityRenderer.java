...
public class ReadyToHatchPinkGronckleEggEntityRenderer extends MobRenderer<ReadyToHatchPinkGronckleEggEntityEntity, ModelGronckleEggItemImprovedentity<ReadyToHatchPinkGronckleEggEntityEntity>> {
	public ReadyToHatchPinkGronckleEggEntityRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public ResourceLocation getTextureLocation(ReadyToHatchPinkGronckleEggEntityEntity entity) {
