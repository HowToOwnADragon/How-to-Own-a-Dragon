...
public class AdolescentTTMaleRenderer extends GeoEntityRenderer<AdolescentTTMaleEntity> {
	public AdolescentTTMaleRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, AdolescentTTMaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
