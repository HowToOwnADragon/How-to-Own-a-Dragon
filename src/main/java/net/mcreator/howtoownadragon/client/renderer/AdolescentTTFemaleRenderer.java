...
public class AdolescentTTFemaleRenderer extends GeoEntityRenderer<AdolescentTTFemaleEntity> {
	public AdolescentTTFemaleRenderer(EntityRendererProvider.Context renderManager) {
	...
	@Override
	public void preRender(PoseStack poseStack, AdolescentTTFemaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
