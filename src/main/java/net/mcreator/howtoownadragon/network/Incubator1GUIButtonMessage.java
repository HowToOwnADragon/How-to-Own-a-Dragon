...
public class Incubator1GUIButtonMessage {
	...
	public static void handler(Incubator1GUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			Incubator1HatchButtonProcedure.execute(world, x, y, z);
		}
	}
