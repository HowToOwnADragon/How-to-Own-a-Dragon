...
public class IncubatorBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public IncubatorBlockEntity(BlockPos position, BlockState state) {
		super(HowToOwnADragonModBlockEntities.INCUBATOR.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new IncubatorGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
