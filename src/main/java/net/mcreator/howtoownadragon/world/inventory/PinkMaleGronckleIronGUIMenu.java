...
public class PinkMaleGronckleIronGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PinkMaleGronckleIronGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.PINK_MALE_GRONCKLE_IRON_GUI.get(), id);
