...
public class FemaleGroncklePinkGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FemaleGroncklePinkGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.FEMALE_GRONCKLE_PINK_GUI.get(), id);
