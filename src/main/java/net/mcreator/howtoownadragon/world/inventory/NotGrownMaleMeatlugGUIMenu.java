...
public class NotGrownMaleMeatlugGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NotGrownMaleMeatlugGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.NOT_GROWN_MALE_MEATLUG_GUI.get(), id);
