...
public class MaleGronckleBlueYellowGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MaleGronckleBlueYellowGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.MALE_GRONCKLE_BLUE_YELLOW_GUI.get(), id);
