...
public class NotGrownFemaleGronckleBlueYellowGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NotGrownFemaleGronckleBlueYellowGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.NOT_GROWN_FEMALE_GRONCKLE_BLUE_YELLOW_GUI.get(), id);
