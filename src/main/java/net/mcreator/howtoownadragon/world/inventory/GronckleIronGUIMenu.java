...
public class GronckleIronGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GronckleIronGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.GRONCKLE_IRON_GUI.get(), id);
