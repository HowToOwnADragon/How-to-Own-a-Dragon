...
public class OrangeRedMaleGronckleIronGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public OrangeRedMaleGronckleIronGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.ORANGE_RED_MALE_GRONCKLE_IRON_GUI.get(), id);
