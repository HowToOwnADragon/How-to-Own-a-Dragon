...
public class FemaleMeatlugGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FemaleMeatlugGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.FEMALE_MEATLUG_GUI.get(), id);
