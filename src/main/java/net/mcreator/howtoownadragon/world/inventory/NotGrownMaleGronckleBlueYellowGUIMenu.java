...
public class NotGrownMaleGronckleBlueYellowGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NotGrownMaleGronckleBlueYellowGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.NOT_GROWN_MALE_GRONCKLE_BLUE_YELLOW_GUI.get(), id);
