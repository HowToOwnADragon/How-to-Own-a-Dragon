...
public class NotGrownFemaleGronckleOrangeRedGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NotGrownFemaleGronckleOrangeRedGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.NOT_GROWN_FEMALE_GRONCKLE_ORANGE_RED_GUI.get(), id);
