...
public class GronckleInventoryMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GronckleInventoryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.GRONCKLE_INVENTORY.get(), id);
