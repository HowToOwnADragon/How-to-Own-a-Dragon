...
public class NotGrownMaleGroncklePinkGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NotGrownMaleGroncklePinkGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.NOT_GROWN_MALE_GRONCKLE_PINK_GUI.get(), id);
