...
public class OrangeRedFemaleGronckleIronGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public OrangeRedFemaleGronckleIronGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.ORANGE_RED_FEMALE_GRONCKLE_IRON_GUI.get(), id);
