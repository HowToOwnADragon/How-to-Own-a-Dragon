...
public class MeatlugFemaleGronckleIronGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MeatlugFemaleGronckleIronGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.MEATLUG_FEMALE_GRONCKLE_IRON_GUI.get(), id);
