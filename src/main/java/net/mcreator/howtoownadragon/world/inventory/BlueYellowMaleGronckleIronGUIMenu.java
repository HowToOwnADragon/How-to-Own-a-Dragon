...
public class BlueYellowMaleGronckleIronGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BlueYellowMaleGronckleIronGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.BLUE_YELLOW_MALE_GRONCKLE_IRON_GUI.get(), id);
