...
public class NotGrownMaleGronckleOrangeRedGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NotGrownMaleGronckleOrangeRedGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.NOT_GROWN_MALE_GRONCKLE_ORANGE_RED_GUI.get(), id);
