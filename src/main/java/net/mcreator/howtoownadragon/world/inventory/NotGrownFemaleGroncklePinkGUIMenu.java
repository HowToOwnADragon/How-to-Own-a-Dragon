...
public class NotGrownFemaleGroncklePinkGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NotGrownFemaleGroncklePinkGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.NOT_GROWN_FEMALE_GRONCKLE_PINK_GUI.get(), id);
