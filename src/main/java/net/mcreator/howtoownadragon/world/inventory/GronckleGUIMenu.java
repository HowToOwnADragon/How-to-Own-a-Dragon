...
public class GronckleGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GronckleGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.GRONCKLE_GUI.get(), id);
