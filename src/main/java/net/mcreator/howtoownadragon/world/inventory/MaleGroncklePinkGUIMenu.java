...
public class MaleGroncklePinkGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MaleGroncklePinkGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.MALE_GRONCKLE_PINK_GUI.get(), id);
