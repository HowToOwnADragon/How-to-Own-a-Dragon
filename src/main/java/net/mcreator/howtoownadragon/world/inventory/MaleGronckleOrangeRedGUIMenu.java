...
public class MaleGronckleOrangeRedGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MaleGronckleOrangeRedGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HowToOwnADragonModMenus.MALE_GRONCKLE_ORANGE_RED_GUI.get(), id);
