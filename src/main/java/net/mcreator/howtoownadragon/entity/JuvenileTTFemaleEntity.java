...
public class JuvenileTTFemaleEntity extends TamableAnimal implements GeoEntity {
	...
	public JuvenileTTFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.JUVENILE_TT_FEMALE.get(), world);
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(JuvenileTTFemaleEntity.this.getId());
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.JUVENILE_TT_FEMALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(JuvenileTTFemaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
