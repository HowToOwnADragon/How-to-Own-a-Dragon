...
public class MeatlugMaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MeatlugMaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MeatlugMaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MeatlugMaleEntity.class, EntityDataSerializers.STRING);
	...
	public MeatlugMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.MEATLUG_MALE.get(), world);
	}

	public MeatlugMaleEntity(EntityType<MeatlugMaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = MeatlugMaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = MeatlugMaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = MeatlugMaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MeatlugMaleEntity retval = HowToOwnADragonModEntities.MEATLUG_MALE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MeatlugMaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
