...
public class AdolescentGroncklePinkMaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolescentGroncklePinkMaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolescentGroncklePinkMaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolescentGroncklePinkMaleEntity.class, EntityDataSerializers.STRING);
	...
	public AdolescentGroncklePinkMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_PINK_MALE.get(), world);
	}

	public AdolescentGroncklePinkMaleEntity(EntityType<AdolescentGroncklePinkMaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(11, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = AdolescentGroncklePinkMaleEntity.this.getRandom();
				double dir_x = AdolescentGroncklePinkMaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolescentGroncklePinkMaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolescentGroncklePinkMaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(AdolescentGroncklePinkMaleEntity.this.getId());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolescentGroncklePinkMaleEntity retval = HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_PINK_MALE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolescentGroncklePinkMaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
