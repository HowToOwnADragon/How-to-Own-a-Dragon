...
import net.mcreator.howtoownadragon.procedures.GrowingTickRateYakProcedure;
...
public class BabyYakEntity extends TamableAnimal implements GeoEntity {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GrowingTickRateYakProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
