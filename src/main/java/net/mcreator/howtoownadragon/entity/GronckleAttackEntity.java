...
public class GronckleAttackEntity extends AbstractArrow implements ItemSupplier {
	public GronckleAttackEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(HowToOwnADragonModEntities.GRONCKLE_ATTACK.get(), world);
	}
	...
	public static GronckleAttackEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		GronckleAttackEntity entityarrow = new GronckleAttackEntity(HowToOwnADragonModEntities.GRONCKLE_ATTACK.get(), entity, world);
	...
	public static GronckleAttackEntity shoot(LivingEntity entity, LivingEntity target) {
		GronckleAttackEntity entityarrow = new GronckleAttackEntity(HowToOwnADragonModEntities.GRONCKLE_ATTACK.get(), entity, entity.level);
