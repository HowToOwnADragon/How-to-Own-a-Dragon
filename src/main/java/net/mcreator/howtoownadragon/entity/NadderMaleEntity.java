...
public class NadderMaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(NadderMaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(NadderMaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(NadderMaleEntity.class, EntityDataSerializers.STRING);
	...
	public NadderMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.NADDER_MALE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new LookAtPlayerGoal(this, ServerPlayer.class, (float) 3) {
			...
			public boolean canUse() {
				double x = NadderMaleEntity.this.getX();
				double y = NadderMaleEntity.this.getY();
				double z = NadderMaleEntity.this.getZ();
				Entity entity = NadderMaleEntity.this;
				Level world = NadderMaleEntity.this.level;
		...
		this.goalSelector.addGoal(12, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = NadderMaleEntity.this.getRandom();
				double dir_x = NadderMaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = NadderMaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = NadderMaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(NadderMaleEntity.this.getId());
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.NADDER_MALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(NadderMaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
