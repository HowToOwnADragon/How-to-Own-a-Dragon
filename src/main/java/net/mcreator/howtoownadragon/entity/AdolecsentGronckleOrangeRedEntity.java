...
public class AdolecsentGronckleOrangeRedEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolecsentGronckleOrangeRedEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolecsentGronckleOrangeRedEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolecsentGronckleOrangeRedEntity.class, EntityDataSerializers.STRING);
	...
	public AdolecsentGronckleOrangeRedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLECSENT_GRONCKLE_ORANGE_RED.get(), world);
	}

	public AdolecsentGronckleOrangeRedEntity(EntityType<AdolecsentGronckleOrangeRedEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(12, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = AdolecsentGronckleOrangeRedEntity.this.getRandom();
				double dir_x = AdolecsentGronckleOrangeRedEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolecsentGronckleOrangeRedEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolecsentGronckleOrangeRedEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolecsentGronckleOrangeRedEntity retval = HowToOwnADragonModEntities.ADOLECSENT_GRONCKLE_ORANGE_RED.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolecsentGronckleOrangeRedEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
