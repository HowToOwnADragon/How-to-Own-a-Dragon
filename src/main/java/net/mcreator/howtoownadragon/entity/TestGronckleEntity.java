...
public class TestGronckleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TestGronckleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TestGronckleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TestGronckleEntity.class, EntityDataSerializers.STRING);
	...
	public TestGronckleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.TEST_GRONCKLE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(10, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = TestGronckleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = TestGronckleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = TestGronckleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TestGronckleEntity retval = HowToOwnADragonModEntities.TEST_GRONCKLE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.TEST_GRONCKLE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(TestGronckleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
