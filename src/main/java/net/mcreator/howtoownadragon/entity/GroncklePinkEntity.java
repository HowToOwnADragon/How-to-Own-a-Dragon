...
public class GroncklePinkEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GroncklePinkEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GroncklePinkEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GroncklePinkEntity.class, EntityDataSerializers.STRING);
	...
	public GroncklePinkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.GRONCKLE_PINK.get(), world);
	}

	public GroncklePinkEntity(EntityType<GroncklePinkEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GroncklePinkEntity.this.getRandom();
				double dir_x = GroncklePinkEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = GroncklePinkEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = GroncklePinkEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GroncklePinkEntity retval = HowToOwnADragonModEntities.GRONCKLE_PINK.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.GRONCKLE_PINK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GroncklePinkEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
