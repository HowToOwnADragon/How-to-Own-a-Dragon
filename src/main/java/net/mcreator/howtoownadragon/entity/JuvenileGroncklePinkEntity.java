...
public class JuvenileGroncklePinkEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(JuvenileGroncklePinkEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(JuvenileGroncklePinkEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(JuvenileGroncklePinkEntity.class, EntityDataSerializers.STRING);
	...
	public JuvenileGroncklePinkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.JUVENILE_GRONCKLE_PINK.get(), world);
	}

	public JuvenileGroncklePinkEntity(EntityType<JuvenileGroncklePinkEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(12, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = JuvenileGroncklePinkEntity.this.getRandom();
				double dir_x = JuvenileGroncklePinkEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = JuvenileGroncklePinkEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = JuvenileGroncklePinkEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JuvenileGroncklePinkEntity retval = HowToOwnADragonModEntities.JUVENILE_GRONCKLE_PINK.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(JuvenileGroncklePinkEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
