...
public class JuvenileGronckleFemaleEntity extends TamableAnimal implements GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(JuvenileGronckleFemaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(JuvenileGronckleFemaleEntity.class, EntityDataSerializers.STRING);
	...
	public JuvenileGronckleFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.JUVENILE_GRONCKLE_FEMALE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = JuvenileGronckleFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = JuvenileGronckleFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Juvenile Female Gronckle");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(JuvenileGronckleFemaleEntity.this.getId());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JuvenileGronckleFemaleEntity retval = HowToOwnADragonModEntities.JUVENILE_GRONCKLE_FEMALE.get().create(serverWorld);
