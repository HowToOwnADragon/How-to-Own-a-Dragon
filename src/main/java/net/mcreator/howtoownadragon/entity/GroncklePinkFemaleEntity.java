...
public class GroncklePinkFemaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GroncklePinkFemaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GroncklePinkFemaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GroncklePinkFemaleEntity.class, EntityDataSerializers.STRING);
	...
	public GroncklePinkFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.GRONCKLE_PINK_FEMALE.get(), world);
	}

	public GroncklePinkFemaleEntity(EntityType<GroncklePinkFemaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "groncklepink");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new TemptGoal(this, 0, Ingredient.of(Blocks.ANDESITE.asItem()), false));
		this.goalSelector.addGoal(7, new TemptGoal(this, 0, Ingredient.of(Blocks.DIORITE.asItem()), false));
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GroncklePinkFemaleEntity.this.getRandom();
				double dir_x = GroncklePinkFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = GroncklePinkFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = GroncklePinkFemaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = GroncklePinkFemaleEntity.this.getX();
				double y = GroncklePinkFemaleEntity.this.getY();
				double z = GroncklePinkFemaleEntity.this.getZ();
				Entity entity = GroncklePinkFemaleEntity.this;
				Level world = GroncklePinkFemaleEntity.this.level;
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(GroncklePinkFemaleEntity.this.getId());
						return new FemaleGroncklePinkGUIMenu(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GroncklePinkFemaleEntity retval = HowToOwnADragonModEntities.GRONCKLE_PINK_FEMALE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.GRONCKLE_PINK_FEMALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GroncklePinkFemaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
