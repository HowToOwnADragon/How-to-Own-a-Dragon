	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GronckleBlueYellowFemaleEntity.this.getRandom();
				double dir_x = GronckleBlueYellowFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = GronckleBlueYellowFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
