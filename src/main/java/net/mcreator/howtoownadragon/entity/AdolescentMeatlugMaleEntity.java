...
public class AdolescentMeatlugMaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolescentMeatlugMaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolescentMeatlugMaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolescentMeatlugMaleEntity.class, EntityDataSerializers.STRING);
	...
	public AdolescentMeatlugMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLESCENT_MEATLUG_MALE.get(), world);
	}

	public AdolescentMeatlugMaleEntity(EntityType<AdolescentMeatlugMaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(11, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = AdolescentMeatlugMaleEntity.this.getRandom();
				double dir_x = AdolescentMeatlugMaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolescentMeatlugMaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolescentMeatlugMaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(AdolescentMeatlugMaleEntity.this.getId());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolescentMeatlugMaleEntity retval = HowToOwnADragonModEntities.ADOLESCENT_MEATLUG_MALE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolescentMeatlugMaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
