...
public class JuvenileTTMaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(JuvenileTTMaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(JuvenileTTMaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(JuvenileTTMaleEntity.class, EntityDataSerializers.STRING);
	...
	public JuvenileTTMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.JUVENILE_TT_MALE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 3, (float) 32, false) {
			...
			public boolean canUse() {
				double x = JuvenileTTMaleEntity.this.getX();
				double y = JuvenileTTMaleEntity.this.getY();
				double z = JuvenileTTMaleEntity.this.getZ();
				Entity entity = JuvenileTTMaleEntity.this;
				Level world = JuvenileTTMaleEntity.this.level;
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(JuvenileTTMaleEntity.this.getId());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JuvenileTTMaleEntity retval = HowToOwnADragonModEntities.JUVENILE_TT_MALE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.JUVENILE_TT_MALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(JuvenileTTMaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
