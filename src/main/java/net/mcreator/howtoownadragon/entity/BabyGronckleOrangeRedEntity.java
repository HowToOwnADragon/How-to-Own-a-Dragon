...
public class BabyGronckleOrangeRedEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BabyGronckleOrangeRedEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BabyGronckleOrangeRedEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BabyGronckleOrangeRedEntity.class, EntityDataSerializers.STRING);
	...
	public BabyGronckleOrangeRedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.BABY_GRONCKLE_ORANGE_RED.get(), world);
	}

	public BabyGronckleOrangeRedEntity(EntityType<BabyGronckleOrangeRedEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BabyGronckleOrangeRedEntity retval = HowToOwnADragonModEntities.BABY_GRONCKLE_ORANGE_RED.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BabyGronckleOrangeRedEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
