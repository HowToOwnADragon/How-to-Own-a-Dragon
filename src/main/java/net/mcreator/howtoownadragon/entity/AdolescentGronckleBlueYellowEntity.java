...
public class AdolescentGronckleBlueYellowEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolescentGronckleBlueYellowEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolescentGronckleBlueYellowEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolescentGronckleBlueYellowEntity.class, EntityDataSerializers.STRING);
	...
	public AdolescentGronckleBlueYellowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_BLUE_YELLOW.get(), world);
	}

	public AdolescentGronckleBlueYellowEntity(EntityType<AdolescentGronckleBlueYellowEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(12, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = AdolescentGronckleBlueYellowEntity.this.getRandom();
				double dir_x = AdolescentGronckleBlueYellowEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolescentGronckleBlueYellowEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolescentGronckleBlueYellowEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolescentGronckleBlueYellowEntity retval = HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_BLUE_YELLOW.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolescentGronckleBlueYellowEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
