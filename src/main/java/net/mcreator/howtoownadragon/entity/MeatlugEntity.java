...
public class MeatlugEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MeatlugEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MeatlugEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MeatlugEntity.class, EntityDataSerializers.STRING);
	...
	public MeatlugEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.MEATLUG.get(), world);
	}

	public MeatlugEntity(EntityType<MeatlugEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = MeatlugEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = MeatlugEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = MeatlugEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MeatlugEntity retval = HowToOwnADragonModEntities.MEATLUG.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MeatlugEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
