...
import net.mcreator.howtoownadragon.procedures.PinkGronckleEggEntityProcedureProcedure;
...
public class PinkGronckleEggEntityEntity extends PathfinderMob {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		PinkGronckleEggEntityProcedureProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
