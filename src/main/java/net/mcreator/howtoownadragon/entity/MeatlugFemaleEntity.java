...
public class MeatlugFemaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MeatlugFemaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MeatlugFemaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MeatlugFemaleEntity.class, EntityDataSerializers.STRING);
	...
	public MeatlugFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.MEATLUG_FEMALE.get(), world);
	}

	public MeatlugFemaleEntity(EntityType<MeatlugFemaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = MeatlugFemaleEntity.this.getRandom();
				double dir_x = MeatlugFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = MeatlugFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = MeatlugFemaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(MeatlugFemaleEntity.this.getId());
						return new FemaleMeatlugGUIMenu(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MeatlugFemaleEntity retval = HowToOwnADragonModEntities.MEATLUG_FEMALE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MeatlugFemaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
