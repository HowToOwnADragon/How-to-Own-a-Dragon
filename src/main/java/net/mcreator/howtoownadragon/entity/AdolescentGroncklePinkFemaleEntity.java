...
public class AdolescentGroncklePinkFemaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolescentGroncklePinkFemaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolescentGroncklePinkFemaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolescentGroncklePinkFemaleEntity.class, EntityDataSerializers.STRING);
	...
	public AdolescentGroncklePinkFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_PINK_FEMALE.get(), world);
	}

	public AdolescentGroncklePinkFemaleEntity(EntityType<AdolescentGroncklePinkFemaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "adogroncklepink");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(11, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = AdolescentGroncklePinkFemaleEntity.this.getRandom();
				double dir_x = AdolescentGroncklePinkFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolescentGroncklePinkFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolescentGroncklePinkFemaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(AdolescentGroncklePinkFemaleEntity.this.getId());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolescentGroncklePinkFemaleEntity retval = HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_PINK_FEMALE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolescentGroncklePinkFemaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
