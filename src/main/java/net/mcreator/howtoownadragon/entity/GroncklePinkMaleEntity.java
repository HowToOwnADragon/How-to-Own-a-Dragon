...
public class GroncklePinkMaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GroncklePinkMaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GroncklePinkMaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GroncklePinkMaleEntity.class, EntityDataSerializers.STRING);
	...
	public GroncklePinkMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.GRONCKLE_PINK_MALE.get(), world);
	}

	public GroncklePinkMaleEntity(EntityType<GroncklePinkMaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GroncklePinkMaleEntity.this.getRandom();
				double dir_x = GroncklePinkMaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = GroncklePinkMaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(GroncklePinkMaleEntity.this.getId());
						return new MaleGroncklePinkGUIMenu(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GroncklePinkMaleEntity retval = HowToOwnADragonModEntities.GRONCKLE_PINK_MALE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.GRONCKLE_PINK_MALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GroncklePinkMaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
