...
public class GronckleOrangeRedFemaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GronckleOrangeRedFemaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GronckleOrangeRedFemaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GronckleOrangeRedFemaleEntity.class, EntityDataSerializers.STRING);
	...
	public GronckleOrangeRedFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.GRONCKLE_ORANGE_RED_FEMALE.get(), world);
	}

	public GronckleOrangeRedFemaleEntity(EntityType<GronckleOrangeRedFemaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GronckleOrangeRedFemaleEntity.this.getRandom();
				double dir_x = GronckleOrangeRedFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = GronckleOrangeRedFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = GronckleOrangeRedFemaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = GronckleOrangeRedFemaleEntity.this.getX();
				double y = GronckleOrangeRedFemaleEntity.this.getY();
				double z = GronckleOrangeRedFemaleEntity.this.getZ();
				Entity entity = GronckleOrangeRedFemaleEntity.this;
				Level world = GronckleOrangeRedFemaleEntity.this.level;
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(GronckleOrangeRedFemaleEntity.this.getId());
						return new FemaleGronckleOrangeRedGUIMenu(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GronckleOrangeRedFemaleEntity retval = HowToOwnADragonModEntities.GRONCKLE_ORANGE_RED_FEMALE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.GRONCKLE_ORANGE_RED_FEMALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GronckleOrangeRedFemaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
