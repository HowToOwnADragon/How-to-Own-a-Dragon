...
public class GronckleBlueYellowMaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GronckleBlueYellowMaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GronckleBlueYellowMaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GronckleBlueYellowMaleEntity.class, EntityDataSerializers.STRING);
	...
	public GronckleBlueYellowMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.GRONCKLE_BLUE_YELLOW_MALE.get(), world);
	}

	public GronckleBlueYellowMaleEntity(EntityType<GronckleBlueYellowMaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(7, new TemptGoal(this, 0, Ingredient.of(Blocks.GRANITE.asItem()), false));
		this.goalSelector.addGoal(8, new TemptGoal(this, 0, Ingredient.of(Blocks.ANDESITE.asItem()), false));
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GronckleBlueYellowMaleEntity.this.getRandom();
				double dir_x = GronckleBlueYellowMaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = GronckleBlueYellowMaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = GronckleBlueYellowMaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
				return new Vec3(dir_x, dir_y, dir_z);
			}

			@Override
			public boolean canUse() {
				double x = GronckleBlueYellowMaleEntity.this.getX();
				double y = GronckleBlueYellowMaleEntity.this.getY();
				double z = GronckleBlueYellowMaleEntity.this.getZ();
				Entity entity = GronckleBlueYellowMaleEntity.this;
				Level world = GronckleBlueYellowMaleEntity.this.level;
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(GronckleBlueYellowMaleEntity.this.getId());
						return new MaleGronckleBlueYellowGUIMenu(id, inventory, packetBuffer);
					}
				}, buf -> {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GronckleBlueYellowMaleEntity retval = HowToOwnADragonModEntities.GRONCKLE_BLUE_YELLOW_MALE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.GRONCKLE_BLUE_YELLOW_MALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GronckleBlueYellowMaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
