...
public class BabyMeatlugEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BabyMeatlugEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BabyMeatlugEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BabyMeatlugEntity.class, EntityDataSerializers.STRING);
	...
	public BabyMeatlugEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.BABY_MEATLUG.get(), world);
	}

	public BabyMeatlugEntity(EntityType<BabyMeatlugEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BabyMeatlugEntity retval = HowToOwnADragonModEntities.BABY_MEATLUG.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BabyMeatlugEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
