...
public class BabyGronckleBlueYellowEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BabyGronckleBlueYellowEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BabyGronckleBlueYellowEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BabyGronckleBlueYellowEntity.class, EntityDataSerializers.STRING);
	...
	public BabyGronckleBlueYellowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.BABY_GRONCKLE_BLUE_YELLOW.get(), world);
	}

	public BabyGronckleBlueYellowEntity(EntityType<BabyGronckleBlueYellowEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BabyGronckleBlueYellowEntity retval = HowToOwnADragonModEntities.BABY_GRONCKLE_BLUE_YELLOW.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BabyGronckleBlueYellowEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
