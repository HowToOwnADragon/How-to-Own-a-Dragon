...
public class AdolescentMeatlugFemaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolescentMeatlugFemaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolescentMeatlugFemaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolescentMeatlugFemaleEntity.class, EntityDataSerializers.STRING);
	...
	public AdolescentMeatlugFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLESCENT_MEATLUG_FEMALE.get(), world);
	}

	public AdolescentMeatlugFemaleEntity(EntityType<AdolescentMeatlugFemaleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(11, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				...
				double dir_x = AdolescentMeatlugFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolescentMeatlugFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolescentMeatlugFemaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(AdolescentMeatlugFemaleEntity.this.getId());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolescentMeatlugFemaleEntity retval = HowToOwnADragonModEntities.ADOLESCENT_MEATLUG_FEMALE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolescentMeatlugFemaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
