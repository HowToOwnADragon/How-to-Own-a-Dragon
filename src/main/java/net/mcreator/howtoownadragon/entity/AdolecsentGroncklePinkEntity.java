...
public class AdolecsentGroncklePinkEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolecsentGroncklePinkEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolecsentGroncklePinkEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolecsentGroncklePinkEntity.class, EntityDataSerializers.STRING);
	...
	public AdolecsentGroncklePinkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLECSENT_GRONCKLE_PINK.get(), world);
	}

	public AdolecsentGroncklePinkEntity(EntityType<AdolecsentGroncklePinkEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(12, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = AdolecsentGroncklePinkEntity.this.getRandom();
				double dir_x = AdolecsentGroncklePinkEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolecsentGroncklePinkEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolecsentGroncklePinkEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolecsentGroncklePinkEntity retval = HowToOwnADragonModEntities.ADOLECSENT_GRONCKLE_PINK.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolecsentGroncklePinkEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
