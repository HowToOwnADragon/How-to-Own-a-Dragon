...
public class NadderFemaleEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(NadderFemaleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(NadderFemaleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(NadderFemaleEntity.class, EntityDataSerializers.STRING);
	...
	public NadderFemaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.NADDER_FEMALE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new LookAtPlayerGoal(this, ServerPlayer.class, (float) 3) {
			...
			public boolean canUse() {
				double x = NadderFemaleEntity.this.getX();
				double y = NadderFemaleEntity.this.getY();
				double z = NadderFemaleEntity.this.getZ();
				Entity entity = NadderFemaleEntity.this;
				Level world = NadderFemaleEntity.this.level;
		...
		this.goalSelector.addGoal(12, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = NadderFemaleEntity.this.getRandom();
				double dir_x = NadderFemaleEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = NadderFemaleEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = NadderFemaleEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		FemaleOnInitialEntitySpawnNadderProcedure.execute(world, this);
		return retval;
	}
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
					...
					public Component getDisplayName() {
						return Component.literal("Female Deadly Nadder");
					}
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(NadderFemaleEntity.this.getId());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		NadderFemaleEntity retval = HowToOwnADragonModEntities.NADDER_FEMALE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.NADDER_FEMALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(NadderFemaleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
