...
public class AdolescentMeatlugEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AdolescentMeatlugEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AdolescentMeatlugEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AdolescentMeatlugEntity.class, EntityDataSerializers.STRING);
	...
	public AdolescentMeatlugEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.ADOLESCENT_MEATLUG.get(), world);
	}

	public AdolescentMeatlugEntity(EntityType<AdolescentMeatlugEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(12, new RandomStrollGoal(this, 0.3, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = AdolescentMeatlugEntity.this.getRandom();
				double dir_x = AdolescentMeatlugEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = AdolescentMeatlugEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = AdolescentMeatlugEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AdolescentMeatlugEntity retval = HowToOwnADragonModEntities.ADOLESCENT_MEATLUG.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AdolescentMeatlugEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
