...
public class GronckleBlueYellowEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(GronckleBlueYellowEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(GronckleBlueYellowEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GronckleBlueYellowEntity.class, EntityDataSerializers.STRING);
	...
	public GronckleBlueYellowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.GRONCKLE_BLUE_YELLOW.get(), world);
	}

	public GronckleBlueYellowEntity(EntityType<GronckleBlueYellowEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(13, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = GronckleBlueYellowEntity.this.getRandom();
				double dir_x = GronckleBlueYellowEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = GronckleBlueYellowEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = GronckleBlueYellowEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GronckleBlueYellowEntity retval = HowToOwnADragonModEntities.GRONCKLE_BLUE_YELLOW.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(HowToOwnADragonModEntities.GRONCKLE_BLUE_YELLOW.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GronckleBlueYellowEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
