...
public class BabyGroncklePinkEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BabyGroncklePinkEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BabyGroncklePinkEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BabyGroncklePinkEntity.class, EntityDataSerializers.STRING);
	...
	public BabyGroncklePinkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HowToOwnADragonModEntities.BABY_GRONCKLE_PINK.get(), world);
	}

	public BabyGroncklePinkEntity(EntityType<BabyGroncklePinkEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BabyGroncklePinkEntity retval = HowToOwnADragonModEntities.BABY_GRONCKLE_PINK.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BabyGroncklePinkEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
