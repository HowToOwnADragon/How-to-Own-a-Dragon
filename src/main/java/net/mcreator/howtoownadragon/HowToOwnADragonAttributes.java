...
public class HowToOwnADragonAttributes {
    ...
    public static final RegistryObject<Attribute> GRONCKLEIRONCOOLDOWN = ATTRIBUTES.register("gronckle_iron_cooldown", () -> (new RangedAttribute("attribute." + HowToOwnADragonMod.MODID + ".gronckle_iron_cooldown", 600, 0, 16384)).setSyncable(true));
