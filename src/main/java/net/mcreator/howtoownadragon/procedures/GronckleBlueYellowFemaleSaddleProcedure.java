...
public class GronckleBlueYellowFemaleSaddleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof GronckleBlueYellowFemaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
			...
			if (entity instanceof GronckleBlueYellowFemaleEntity animatable)
				animatable.setTexture("gronckleblueyellowsaddle");
		} else if (entity instanceof GronckleBlueYellowFemaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
