...
public class MeatlugAndOrangeRedMaleGronckleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (!(((Entity) world.getEntitiesOfClass(GronckleOrangeRedFemaleEntity.class, AABB.ofSize(new Vec3(x, y, z), 10, 10, 10), e -> true).stream().sorted(new Object() {
			...
			if (entity instanceof MeatlugMaleEntity) {
				if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Blocks.STONE.asItem()) {
					if (((Entity) world.getEntitiesOfClass(GronckleOrangeRedFemaleEntity.class, AABB.ofSize(new Vec3(x, y, z), 10, 10, 10), e -> true).stream().sorted(new Object() {
						...
						MeatlugAndOrangeRedEggSpawnProcedure.execute(entity);
					}
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt49 && _livEnt49.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt58 && _livEnt58.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt67 && _livEnt67.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
