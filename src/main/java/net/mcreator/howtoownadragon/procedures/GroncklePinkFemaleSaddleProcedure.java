...
public class GroncklePinkFemaleSaddleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof GroncklePinkFemaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
			...
			if (entity instanceof GroncklePinkFemaleEntity animatable)
				animatable.setTexture("groncklepinksaddle");
		} else if (entity instanceof GroncklePinkFemaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
