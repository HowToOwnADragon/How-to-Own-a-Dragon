...
public class TextureFixGronckleMaleRandomProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		HowToOwnADragonMod.queueServerWork(2, () -> {
			if (!(entity.getPersistentData().getBoolean("groncklerandomcolor") == true)) {
				entity.getPersistentData().putBoolean("loadedgronckle", true);
				entity.getPersistentData().putBoolean("groncklerandomcolor", true);
