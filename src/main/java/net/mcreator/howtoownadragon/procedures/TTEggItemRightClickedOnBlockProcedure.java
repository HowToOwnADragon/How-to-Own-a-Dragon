...
public class TTEggItemRightClickedOnBlockProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == HowToOwnADragonModItems.TT_EGG_ITEM.get()) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new TTEggEntityEntity(HowToOwnADragonModEntities.TT_EGG_ENTITY.get(), _level);
