...
public class GronckleOrangeRedMaleSaddleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof GronckleOrangeRedMaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
			...
			if (entity instanceof GronckleOrangeRedMaleEntity animatable)
				animatable.setTexture("gronckleorangeredsaddle");
		} else if (entity instanceof GronckleOrangeRedMaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
