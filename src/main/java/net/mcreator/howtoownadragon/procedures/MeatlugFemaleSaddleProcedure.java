...
public class MeatlugFemaleSaddleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof MeatlugFemaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
			...
			if (entity instanceof MeatlugFemaleEntity animatable)
				animatable.setTexture("meatlugsaddle");
		} else if (entity instanceof MeatlugFemaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
