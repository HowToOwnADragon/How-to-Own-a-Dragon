...
public class ReplaceSheepProcedure {
	@SubscribeEvent
			...
			if (entity instanceof Sheep) {
				if (entity instanceof LivingEntity _livEnt ? _livEnt.isBaby() : false) {
					...
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = new BabySheepEntity(HowToOwnADragonModEntities.BABY_SHEEP.get(), _level);
					...
					if (!entity.level.isClientSide())
						entity.discard();
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = new SheepEntity(HowToOwnADragonModEntities.SHEEP.get(), _level);
						entityToSpawn.moveTo(x, y, z, 0, 0);
						entityToSpawn.setYBodyRot(0);
						entityToSpawn.setYHeadRot(0);
						entityToSpawn.setDeltaMovement(0, 0, 0);
