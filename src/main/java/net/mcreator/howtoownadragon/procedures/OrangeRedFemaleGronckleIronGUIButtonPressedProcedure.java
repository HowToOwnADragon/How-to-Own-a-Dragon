...
public class OrangeRedFemaleGronckleIronGUIButtonPressedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(HowToOwnADragonModMobEffects.GRONCKLE_IRON_COOLDOWN.get()))) {
			if (new Object() {
				...
				if ((entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY)
					...
					if (((Entity) world.getEntitiesOfClass(GronckleOrangeRedFemaleEntity.class, AABB.ofSize(new Vec3(x, y, z), 10, 10, 10), e -> true).stream().sorted(new Object() {
						...
						_entity.addEffect(new MobEffectInstance(HowToOwnADragonModMobEffects.GRONCKLE_IRON_COOLDOWN.get(), 100, 1, false, false));
				}
			}
		}
	}
