...
public class MeatlugAndOrangeRedFemaleGronckleProcedure {
	@SubscribeEvent
		...
		if (!(entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(HowToOwnADragonModMobEffects.BREED_COOLDOWN.get()))) {
			if (entity instanceof MeatlugFemaleEntity) {
				if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Blocks.STONE.asItem()) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt19 && _livEnt19.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt27 && _livEnt27.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt35 && _livEnt35.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt43 && _livEnt43.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
