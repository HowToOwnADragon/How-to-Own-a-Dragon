...
public class GroncklePinkMaleSaddleProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof GroncklePinkMaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
			...
			if (entity instanceof GroncklePinkMaleEntity animatable)
				animatable.setTexture("groncklepinksaddle");
		} else if (entity instanceof GroncklePinkMaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)
