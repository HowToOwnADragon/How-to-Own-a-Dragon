...
public class SaddleFemaleNadderProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		...
		if (entity instanceof NadderFemaleEntity && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)) {
			if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == HowToOwnADragonModItems.NADDER_SADDLE.get() && entity.getPersistentData().getBoolean("Saddle") == false) {
				...
				if ((entity.getPersistentData().getString("Color")).equals("stormfly")) {
					if (entity instanceof NadderFemaleEntity animatable)
						animatable.setTexture("stormflysaddle");
				} else if ((entity.getPersistentData().getString("Color")).equals("red")) {
					if (entity instanceof NadderFemaleEntity animatable)
						animatable.setTexture("rednaddersaddle");
				} else if ((entity.getPersistentData().getString("Color")).equals("purple")) {
					if (entity instanceof NadderFemaleEntity animatable)
