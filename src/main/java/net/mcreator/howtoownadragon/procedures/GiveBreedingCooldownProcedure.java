...
public class GiveBreedingCooldownProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		}.compareDistOf(x, y, z)).findFirst().orElse(null)).getPersistentData().putBoolean("groncklebreedingcooldown", true);
		...
		EndingBreedingCooldownProcedure.execute(world, x, y, z);
	}
}
