...
public class BlueYellowMaleGronckleIronGUIButtonPressedProcedure {
			...
			if (new Object() {
				...
				if ((entity instanceof ServerPlayer _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY)
					...
					if (((Entity) world.getEntitiesOfClass(GronckleBlueYellowMaleEntity.class, AABB.ofSize(new Vec3(x, y, z), 10, 10, 10), e -> true).stream().sorted(new Object() {
						...
						_entity.addEffect(new MobEffectInstance(HowToOwnADragonModMobEffects.GRONCKLE_IRON_COOLDOWN.get(), 72000, 1, false, false));
				}
			}
		}
	}
