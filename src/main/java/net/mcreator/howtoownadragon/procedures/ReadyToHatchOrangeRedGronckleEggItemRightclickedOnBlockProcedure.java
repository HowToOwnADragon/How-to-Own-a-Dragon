...
public class ReadyToHatchOrangeRedGronckleEggItemRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(HowToOwnADragonModItems.READY_TO_HATCH_ORANGE_RED_GRONCKLE_EGG_ITEM.get());
