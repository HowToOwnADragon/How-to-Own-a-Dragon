...
public class OrangeRedAndPinkFemaleGronckleProcedure {
	@SubscribeEvent
				...
				if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Blocks.STONE.asItem()) {
					if (((Entity) world.getEntitiesOfClass(GroncklePinkMaleEntity.class, AABB.ofSize(new Vec3(x, y, z), 10, 10, 10), e -> true).stream().sorted(new Object() {
						...
						if (entity instanceof LivingEntity _entity && !_entity.level.isClientSide())
							_entity.addEffect(new MobEffectInstance(HowToOwnADragonModMobEffects.BREED_COOLDOWN.get(), 60, 1, false, false));
						PinkAndOrangeRedEggSpawnProcedure.execute(entity);
					}
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt13 && _livEnt13.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt21 && _livEnt21.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
					...
					}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof LivingEntity _livEnt45 && _livEnt45.hasEffect(HowToOwnADragonModMobEffects.IN_LOVE.get())) {
						if (sourceentity instanceof Player _player) {
