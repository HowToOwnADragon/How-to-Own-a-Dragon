...
public class BeetrootSeedTameChickenProcedure {
	@SubscribeEvent
			...
			if (entity.getType().is(TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation("how_to_own_a_dragon:chickens")))) {
				if (!(entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false)) {
					if (new Object() {
						...
						if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BEETROOT_SEEDS) {
							if (Math.random() < 0.7) {
