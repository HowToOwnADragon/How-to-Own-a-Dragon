...
public class TurqGrowUpProcedureTTProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (entity instanceof BabyTTMaleEntity) {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new JuvenileTTMaleEntity(HowToOwnADragonModEntities.DELETED_MOD_ELEMENT.get(), _level);
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.HAPPY_VILLAGER, x, y, z, 30, 3, 3, 3, 0.5);
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new TTFemaleEntity(HowToOwnADragonModEntities.DELETED_MOD_ELEMENT.get(), _level);
				entityToSpawn.moveTo(x, y, z, 0, 0);
				entityToSpawn.setYBodyRot(0);
				entityToSpawn.setYHeadRot(0);
				entityToSpawn.setDeltaMovement(0, 0, 0);
