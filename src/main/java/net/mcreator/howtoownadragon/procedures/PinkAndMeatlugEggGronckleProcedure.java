...
public class PinkAndMeatlugEggGronckleProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (Mth.nextInt(RandomSource.create(), 1, 2) == 1) {
			...
			entity.getPersistentData().putString("groncklecolor", "meatlug");
			...
			PinkAndMeatlugEggGronckleProcedure.execute(world, x, y, z, entity);
		}
	}
}
