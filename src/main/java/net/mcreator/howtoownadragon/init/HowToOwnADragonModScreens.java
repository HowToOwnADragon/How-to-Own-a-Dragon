...
import net.mcreator.howtoownadragon.client.gui.NotGrownMaleMeatlugGUIScreen;
import net.mcreator.howtoownadragon.client.gui.NotGrownMaleGroncklePinkGUIScreen;
import net.mcreator.howtoownadragon.client.gui.NotGrownMaleGronckleOrangeRedGUIScreen;
import net.mcreator.howtoownadragon.client.gui.NotGrownMaleGronckleBlueYellowGUIScreen;
import net.mcreator.howtoownadragon.client.gui.NotGrownFemaleMeatlugGUIScreen;
import net.mcreator.howtoownadragon.client.gui.NotGrownFemaleGroncklePinkGUIScreen;
import net.mcreator.howtoownadragon.client.gui.NotGrownFemaleGronckleOrangeRedGUIScreen;
import net.mcreator.howtoownadragon.client.gui.NotGrownFemaleGronckleBlueYellowGUIScreen;
...
public class HowToOwnADragonModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(HowToOwnADragonModMenus.NOT_GROWN_MALE_MEATLUG_GUI.get(), NotGrownMaleMeatlugGUIScreen::new);
			MenuScreens.register(HowToOwnADragonModMenus.NOT_GROWN_MALE_GRONCKLE_PINK_GUI.get(), NotGrownMaleGroncklePinkGUIScreen::new);
			MenuScreens.register(HowToOwnADragonModMenus.NOT_GROWN_MALE_GRONCKLE_ORANGE_RED_GUI.get(), NotGrownMaleGronckleOrangeRedGUIScreen::new);
			MenuScreens.register(HowToOwnADragonModMenus.NOT_GROWN_MALE_GRONCKLE_BLUE_YELLOW_GUI.get(), NotGrownMaleGronckleBlueYellowGUIScreen::new);
			MenuScreens.register(HowToOwnADragonModMenus.NOT_GROWN_FEMALE_MEATLUG_GUI.get(), NotGrownFemaleMeatlugGUIScreen::new);
