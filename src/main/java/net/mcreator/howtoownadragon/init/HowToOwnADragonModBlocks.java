...
import net.mcreator.howtoownadragon.block.CustomBlackstoneBlock;
...
public class HowToOwnADragonModBlocks {
	...
	public static final RegistryObject<Block> CUSTOM_BLACKSTONE = REGISTRY.register("custom_blackstone", () -> new CustomBlackstoneBlock());
}
