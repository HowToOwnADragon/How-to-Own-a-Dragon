...
public class AdolescentGronckleMaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public AdolescentGronckleMaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_MALE.get(), world);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(3, new RandomStrollGoal(this, 0.8D, 20) {
         protected Vec3 m_7037_() {
            RandomSource random = AdolescentGronckleMaleEntity.this.m_217043_();
            double dir_x = AdolescentGronckleMaleEntity.this.m_20185_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_y = AdolescentGronckleMaleEntity.this.m_20186_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_z = AdolescentGronckleMaleEntity.this.m_20189_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      AdolescentGronckleMaleEntity retval = (AdolescentGronckleMaleEntity)((EntityType)HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_MALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(AdolescentGronckleMaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(AdolescentGronckleMaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(AdolescentGronckleMaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
