...
public class TTEggEntityEntity extends PathfinderMob implements GeoEntity {
   ...
   public TTEggEntityEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.TT_EGG_ENTITY.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "tteggtexture");
   }
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      TTEggEntityEntityIsHurtProcedure.execute(this.f_19853_, this, source.m_7639_());
   ...
   public InteractionResult m_6071_(Player sourceentity, InteractionHand hand) {
      ...
      TTEggEntityEntityIsHurtProcedure.execute(world, this, sourceentity);
      return retval;
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      return this.animationprocedure.equals("empty") ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.tteggmodelentity.idle")) : PlayState.STOP;
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(TTEggEntityEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(TTEggEntityEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(TTEggEntityEntity.class, EntityDataSerializers.f_135030_);
   }
}
