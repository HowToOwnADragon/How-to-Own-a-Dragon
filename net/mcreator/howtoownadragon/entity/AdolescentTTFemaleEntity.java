...
public class AdolescentTTFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public AdolescentTTFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.ADOLESCENT_TT_FEMALE.get(), world);
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      AdolescentTTFemaleEntity retval = (AdolescentTTFemaleEntity)((EntityType)HowToOwnADragonModEntities.ADOLESCENT_TT_FEMALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(AdolescentTTFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(AdolescentTTFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(AdolescentTTFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
