...
public class BabyNadderMaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public BabyNadderMaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.BABY_NADDER_MALE.get(), world);
   }

   public BabyNadderMaleEntity(EntityType<BabyNadderMaleEntity> type, Level world) {
      super(type, world);
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      BabyNadderMaleEntity retval = (BabyNadderMaleEntity)((EntityType)HowToOwnADragonModEntities.BABY_NADDER_MALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BabyNadderMaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BabyNadderMaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BabyNadderMaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
