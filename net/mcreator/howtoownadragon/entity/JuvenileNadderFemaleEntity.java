...
public class JuvenileNadderFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public JuvenileNadderFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.JUVENILE_NADDER_FEMALE.get(), world);
   }

   public JuvenileNadderFemaleEntity(EntityType<JuvenileNadderFemaleEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(3, new RandomStrollGoal(this, 0.8D, 20) {
         protected Vec3 m_7037_() {
            RandomSource random = JuvenileNadderFemaleEntity.this.m_217043_();
            double dir_x = JuvenileNadderFemaleEntity.this.m_20185_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_y = JuvenileNadderFemaleEntity.this.m_20186_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_z = JuvenileNadderFemaleEntity.this.m_20189_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      JuvenileNadderFemaleEntity retval = (JuvenileNadderFemaleEntity)((EntityType)HowToOwnADragonModEntities.JUVENILE_NADDER_FEMALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(JuvenileNadderFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(JuvenileNadderFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(JuvenileNadderFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
