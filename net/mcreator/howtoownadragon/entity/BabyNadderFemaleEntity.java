...
public class BabyNadderFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public BabyNadderFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.BABY_NADDER_FEMALE.get(), world);
   }

   public BabyNadderFemaleEntity(EntityType<BabyNadderFemaleEntity> type, Level world) {
      super(type, world);
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      BabyNadderFemaleEntity retval = (BabyNadderFemaleEntity)((EntityType)HowToOwnADragonModEntities.BABY_NADDER_FEMALE.get()).m_20615_(serverWorld);
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         return !event.isMoving() && event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.nadder.idle")) : event.setAndContinue(RawAnimation.begin().thenLoop("animation.nadder.walking"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BabyNadderFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BabyNadderFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BabyNadderFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
