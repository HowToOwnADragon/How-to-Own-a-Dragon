...
public class BabyTTFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public BabyTTFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.BABY_TT_FEMALE.get(), world);
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      BabyTTFemaleEntity retval = (BabyTTFemaleEntity)((EntityType)HowToOwnADragonModEntities.BABY_TT_FEMALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BabyTTFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BabyTTFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BabyTTFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
