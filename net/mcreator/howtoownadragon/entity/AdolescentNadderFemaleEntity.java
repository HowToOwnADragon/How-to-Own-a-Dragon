...
public class AdolescentNadderFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public AdolescentNadderFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.ADOLESCENT_NADDER_FEMALE.get(), world);
   }

   public AdolescentNadderFemaleEntity(EntityType<AdolescentNadderFemaleEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(3, new RandomStrollGoal(this, 0.8D, 20) {
         protected Vec3 m_7037_() {
            RandomSource random = AdolescentNadderFemaleEntity.this.m_217043_();
            double dir_x = AdolescentNadderFemaleEntity.this.m_20185_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_y = AdolescentNadderFemaleEntity.this.m_20186_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_z = AdolescentNadderFemaleEntity.this.m_20189_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
   ...
   public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      ColorTickRateNadderProcedure.execute(world, this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      return retval;
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      AdolescentNadderFemaleEntity retval = (AdolescentNadderFemaleEntity)((EntityType)HowToOwnADragonModEntities.ADOLESCENT_NADDER_FEMALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(AdolescentNadderFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(AdolescentNadderFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(AdolescentNadderFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
