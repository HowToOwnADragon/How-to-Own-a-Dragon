...
public class BabyGronckleFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public BabyGronckleFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.BABY_GRONCKLE_FEMALE.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "babymeatlug");
   }
   ...
   public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
      ...
      GronkleColorTickRateProcedure.execute(world, this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
      return retval;
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      BabyGronckleFemaleEntity retval = (BabyGronckleFemaleEntity)((EntityType)HowToOwnADragonModEntities.BABY_GRONCKLE_FEMALE.get()).m_20615_(serverWorld);
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         return !event.isMoving() && event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.babygronckle.idle")) : event.setAndContinue(RawAnimation.begin().thenLoop("animation.babygronckle.walk"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BabyGronckleFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BabyGronckleFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BabyGronckleFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
