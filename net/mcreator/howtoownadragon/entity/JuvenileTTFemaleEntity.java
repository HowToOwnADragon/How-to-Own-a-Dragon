...
public class JuvenileTTFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public JuvenileTTFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.JUVENILE_TT_FEMALE.get(), world);
   }

   public JuvenileTTFemaleEntity(EntityType<JuvenileTTFemaleEntity> type, Level world) {
      super(type, world);
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      JuvenileTTFemaleEntity retval = (JuvenileTTFemaleEntity)((EntityType)HowToOwnADragonModEntities.JUVENILE_TT_FEMALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(JuvenileTTFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(JuvenileTTFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(JuvenileTTFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
