...
public class JuvenileGronckleMaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public JuvenileGronckleMaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.JUVENILE_GRONCKLE_MALE.get(), world);
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(3, new RandomStrollGoal(this, 0.8D, 20) {
         protected Vec3 m_7037_() {
            RandomSource random = JuvenileGronckleMaleEntity.this.m_217043_();
            double dir_x = JuvenileGronckleMaleEntity.this.m_20185_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_y = JuvenileGronckleMaleEntity.this.m_20186_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_z = JuvenileGronckleMaleEntity.this.m_20189_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      JuvenileGronckleMaleEntity retval = (JuvenileGronckleMaleEntity)((EntityType)HowToOwnADragonModEntities.JUVENILE_GRONCKLE_MALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(JuvenileGronckleMaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(JuvenileGronckleMaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(JuvenileGronckleMaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
