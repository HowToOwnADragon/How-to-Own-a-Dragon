...
public class AdolescentTTMaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public AdolescentTTMaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.ADOLESCENT_TT_MALE.get(), world);
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      AdolescentTTMaleEntity retval = (AdolescentTTMaleEntity)((EntityType)HowToOwnADragonModEntities.ADOLESCENT_TT_MALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(AdolescentTTMaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(AdolescentTTMaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(AdolescentTTMaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
