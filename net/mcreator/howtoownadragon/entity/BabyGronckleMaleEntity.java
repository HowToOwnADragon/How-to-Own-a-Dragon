...
public class BabyGronckleMaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public BabyGronckleMaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.BABY_GRONCKLE_MALE.get(), world);
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      BabyGronckleMaleEntity retval = (BabyGronckleMaleEntity)((EntityType)HowToOwnADragonModEntities.BABY_GRONCKLE_MALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BabyGronckleMaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BabyGronckleMaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BabyGronckleMaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
