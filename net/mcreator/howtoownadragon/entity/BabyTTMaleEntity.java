...
public class BabyTTMaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public BabyTTMaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.BABY_TT_MALE.get(), world);
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      BabyTTMaleEntity retval = (BabyTTMaleEntity)((EntityType)HowToOwnADragonModEntities.BABY_TT_MALE.get()).m_20615_(serverWorld);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(BabyTTMaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(BabyTTMaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(BabyTTMaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
