...
public class AdolescentGronckleFemaleEntity extends TamableAnimal implements GeoEntity {
   ...
   public AdolescentGronckleFemaleEntity(SpawnEntity packet, Level world) {
      this((EntityType)HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_FEMALE.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "adomeatlug");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(3, new RandomStrollGoal(this, 0.8D, 20) {
         protected Vec3 m_7037_() {
            RandomSource random = AdolescentGronckleFemaleEntity.this.m_217043_();
            double dir_x = AdolescentGronckleFemaleEntity.this.m_20185_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_y = AdolescentGronckleFemaleEntity.this.m_20186_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
            double dir_z = AdolescentGronckleFemaleEntity.this.m_20189_() + (double)((random.m_188501_() * 2.0F - 1.0F) * 16.0F);
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      AdolescentGronckleFemaleEntity retval = (AdolescentGronckleFemaleEntity)((EntityType)HowToOwnADragonModEntities.ADOLESCENT_GRONCKLE_FEMALE.get()).m_20615_(serverWorld);
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (!this.animationprocedure.equals("empty")) {
         ...
         return !this.m_20096_() ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.adogronckle.flight")) : event.setAndContinue(RawAnimation.begin().thenLoop("animation.adogronckle.idle"));
      }
   }
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(AdolescentGronckleFemaleEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(AdolescentGronckleFemaleEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(AdolescentGronckleFemaleEntity.class, EntityDataSerializers.f_135030_);
   }
}
