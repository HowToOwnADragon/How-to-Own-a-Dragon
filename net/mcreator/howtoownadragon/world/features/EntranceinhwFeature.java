...
public class EntranceinhwFeature extends Feature<NoneFeatureConfiguration> {
   private final Set<ResourceKey<Level>> generate_dimensions;
   private StructureTemplate template;

   public EntranceinhwFeature() {
      super(NoneFeatureConfiguration.f_67815_);
      this.generate_dimensions = Set.of(ResourceKey.m_135785_(Registries.f_256858_, new ResourceLocation("how_to_own_a_dragon:the_hidden_world")));
      this.template = null;
   }
   ...
   public boolean m_142674_(FeaturePlaceContext<NoneFeatureConfiguration> context) {
      if (!this.generate_dimensions.contains(context.m_159774_().m_6018_().m_46472_())) {
         ...
         if (this.template == null) {
            this.template = context.m_159774_().m_6018_().m_215082_().m_230359_(new ResourceLocation("how_to_own_a_dragon", "hw_entrance_in_hw"));
         }
