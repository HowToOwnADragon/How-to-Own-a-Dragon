...
@EventBusSubscriber
public class Incubator1GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
   ...
   public Incubator1GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
      super((MenuType)HowToOwnADragonModMenus.INCUBATOR_1_GUI.get(), id);
      ...
      this.customSlots.put(0, this.m_38897_(new SlotItemHandler(this.internal, 0, 31, 40) {
         public boolean m_5857_(ItemStack stack) {
            return stack.m_204117_(ItemTags.create(new ResourceLocation("how_to_own_a_dragon:eggs")));
         }
      }));
      this.customSlots.put(1, this.m_38897_(new SlotItemHandler(this.internal, 1, 85, 58) {
      }));
      this.customSlots.put(2, this.m_38897_(new SlotItemHandler(this.internal, 2, 85, 22) {
         public boolean m_5857_(ItemStack stack) {
            return false;
         }
      }));
      ...
      for(si = 0; si < 3; ++si) {
         for(int sj = 0; sj < 9; ++sj) {
            this.m_38897_(new Slot(inv, sj + (si + 1) * 9, 12 + sj * 18, 84 + si * 18));
         }
      }

      for(si = 0; si < 9; ++si) {
         this.m_38897_(new Slot(inv, si, 12 + si * 18, 142));
      }
   ...
   public ItemStack m_7648_(Player playerIn, int index) {
      ...
      if (slot != null && slot.m_6657_()) {
         ...
         if (index < 3) {
            ...
            } else if (!this.m_38903_(itemstack1, 3, 30, false)) {
               return ItemStack.f_41583_;
            }
   ...
   public static void onPlayerTick(PlayerTickEvent event) {
      ...
      if (event.phase == Phase.END && entity.f_36096_ instanceof Incubator1GUIMenu) {
         Level world = entity.f_19853_;
         double x = entity.m_20185_();
         double y = entity.m_20186_();
         double z = entity.m_20189_();
         Incubator1TickProcedure.execute(world, x, y, z);
      }
