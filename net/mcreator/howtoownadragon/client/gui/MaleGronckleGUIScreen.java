...
public class MaleGronckleGUIScreen extends AbstractContainerScreen<MaleGronckleGUIMenu> {
   ...
   protected void m_7027_(PoseStack poseStack, int mouseX, int mouseY) {
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.male_gronckle_gui.label_male_gronckle"), 6.0F, 6.0F, -13421773);
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.male_gronckle_gui.label_inventory"), 7.0F, 70.0F, -13421773);
   }
   ...
   public void m_7856_() {
      ...
      this.imagebutton_next_page_mcreator_copy = new ImageButton(this.f_97735_ + 146, this.f_97736_ + 62, 24, 20, 0, 0, 20, new ResourceLocation("how_to_own_a_dragon:textures/screens/atlas/imagebutton_next_page_mcreator_copy.png"), 24, 40, (e) -> {
         HowToOwnADragonMod.PACKET_HANDLER.sendToServer(new MaleGronckleGUIButtonMessage(0, this.x, this.y, this.z));
         MaleGronckleGUIButtonMessage.handleButtonAction(this.entity, 0, this.x, this.y, this.z);
      });
   ...
   static {
      guistate = MaleGronckleGUIMenu.guistate;
      texture = new ResourceLocation("how_to_own_a_dragon:textures/screens/male_gronckle_gui.png");
   }
}
