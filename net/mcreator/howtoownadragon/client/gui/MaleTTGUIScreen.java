...
public class MaleTTGUIScreen extends AbstractContainerScreen<MaleTTGUIMenu> {
   ...
   protected void m_7286_(PoseStack ms, float partialTicks, int gx, int gy) {
      ...
      m_93133_(ms, this.f_97735_ + 111, this.f_97736_ + 6, 0.0F, 0.0F, 10, 11, 10, 11);
   ...
   protected void m_7027_(PoseStack poseStack, int mouseX, int mouseY) {
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.male_ttgui.label_male_gronckle"), 6.0F, 6.0F, -13421773);
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.male_ttgui.label_inventory"), 7.0F, 70.0F, -13421773);
   }
   ...
   static {
      guistate = MaleTTGUIMenu.guistate;
      texture = new ResourceLocation("how_to_own_a_dragon:textures/screens/male_ttgui.png");
   }
}
