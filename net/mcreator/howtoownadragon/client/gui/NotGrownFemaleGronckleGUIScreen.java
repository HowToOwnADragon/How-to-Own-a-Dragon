...
public class NotGrownFemaleGronckleGUIScreen extends AbstractContainerScreen<NotGrownFemaleGronckleGUIMenu> {
   ...
   protected void m_7027_(PoseStack poseStack, int mouseX, int mouseY) {
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.not_grown_female_gronckle_gui.label_male_gronckle"), 6.0F, 6.0F, -13421773);
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.not_grown_female_gronckle_gui.label_inventory"), 7.0F, 70.0F, -13421773);
   }
   ...
   static {
      guistate = NotGrownFemaleGronckleGUIMenu.guistate;
      texture = new ResourceLocation("how_to_own_a_dragon:textures/screens/not_grown_female_gronckle_gui.png");
   }
}
