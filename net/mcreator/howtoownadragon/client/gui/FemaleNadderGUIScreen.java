...
public class FemaleNadderGUIScreen extends AbstractContainerScreen<FemaleNadderGUIMenu> {
   ...
   protected void m_7027_(PoseStack poseStack, int mouseX, int mouseY) {
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.female_nadder_gui.label_male_gronckle"), 6.0F, 6.0F, -13421773);
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.female_nadder_gui.label_inventory"), 7.0F, 70.0F, -13421773);
   }
   ...
   static {
      guistate = FemaleNadderGUIMenu.guistate;
      texture = new ResourceLocation("how_to_own_a_dragon:textures/screens/female_nadder_gui.png");
   }
}
