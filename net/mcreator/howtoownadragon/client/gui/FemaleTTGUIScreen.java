...
public class FemaleTTGUIScreen extends AbstractContainerScreen<FemaleTTGUIMenu> {
   ...
   protected void m_7286_(PoseStack ms, float partialTicks, int gx, int gy) {
      ...
      m_93133_(ms, this.f_97735_ + 118, this.f_97736_ + 4, 0.0F, 0.0F, 11, 12, 11, 12);
   ...
   protected void m_7027_(PoseStack poseStack, int mouseX, int mouseY) {
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.female_ttgui.label_male_gronckle"), 4.0F, 5.0F, -13421773);
      this.f_96547_.m_92889_(poseStack, Component.m_237115_("gui.how_to_own_a_dragon.female_ttgui.label_inventory"), 7.0F, 70.0F, -13421773);
   }
   ...
   static {
      guistate = FemaleTTGUIMenu.guistate;
      texture = new ResourceLocation("how_to_own_a_dragon:textures/screens/female_ttgui.png");
   }
}
