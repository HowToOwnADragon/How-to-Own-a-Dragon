...
public class NadderEggEntityRenderer extends GeoEntityRenderer<NadderEggEntityEntity> {
   public NadderEggEntityRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, NadderEggEntityEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
