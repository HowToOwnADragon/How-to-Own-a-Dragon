...
public class GronckleMaleRenderer extends GeoEntityRenderer<GronckleMaleEntity> {
   public GronckleMaleRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, GronckleMaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
