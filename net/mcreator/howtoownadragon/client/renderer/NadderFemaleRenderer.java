...
public class NadderFemaleRenderer extends GeoEntityRenderer<NadderFemaleEntity> {
   public NadderFemaleRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, NadderFemaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
