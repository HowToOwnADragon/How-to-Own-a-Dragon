...
public class BabyNadderMaleRenderer extends GeoEntityRenderer<BabyNadderMaleEntity> {
   public BabyNadderMaleRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, BabyNadderMaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 0.25F;
