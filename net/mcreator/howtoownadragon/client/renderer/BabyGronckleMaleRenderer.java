...
import net.mcreator.howtoownadragon.entity.model.BabyGronckleMaleModel;
...
public class BabyGronckleMaleRenderer extends GeoEntityRenderer<BabyGronckleMaleEntity> {
   public BabyGronckleMaleRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, BabyGronckleMaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
