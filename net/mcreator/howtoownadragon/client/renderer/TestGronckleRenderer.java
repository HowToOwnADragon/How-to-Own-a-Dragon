...
import net.mcreator.howtoownadragon.entity.model.TestGronckleModel;
...
public class TestGronckleRenderer extends GeoEntityRenderer<TestGronckleEntity> {
   public TestGronckleRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, TestGronckleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
