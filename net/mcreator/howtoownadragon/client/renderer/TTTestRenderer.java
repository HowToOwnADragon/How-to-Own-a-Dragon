...
import net.mcreator.howtoownadragon.entity.model.TTTestModel;
...
public class TTTestRenderer extends GeoEntityRenderer<TTTestEntity> {
   public TTTestRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, TTTestEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.0F;
