...
public class TTFemaleRenderer extends GeoEntityRenderer<TTFemaleEntity> {
   public TTFemaleRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, TTFemaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 0.4F;
