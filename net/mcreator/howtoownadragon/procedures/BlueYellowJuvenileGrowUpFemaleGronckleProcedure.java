...
@EventBusSubscriber
public class BlueYellowJuvenileGrowUpFemaleGronckleProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity.getPersistentData().m_128461_("groncklecolor").equals("blueyellow") && entity instanceof JuvenileGronckleFemaleEntity) {
