...
@EventBusSubscriber
public class PurplePurpleBreedingMaleNadderProcedure {
   @SubscribeEvent
         ...
         if (entity instanceof TamableAnimal) {
            ...
            if (sourceentity instanceof LivingEntity) {
               ...
               if (_tamIsTamedBy.m_21830_(_livEnt) && entity instanceof NadderMaleEntity && !world.m_6443_(NadderFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                  ...
                  })).compareDistOf(x, y, z)).findFirst().orElse((Object)null)).getPersistentData().m_128461_("naddercolor").equals("purple") && entity.getPersistentData().m_128461_("naddercolor").equals("purple")) {
