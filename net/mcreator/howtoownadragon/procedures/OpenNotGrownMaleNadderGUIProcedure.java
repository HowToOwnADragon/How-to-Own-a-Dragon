...
@EventBusSubscriber
public class OpenNotGrownMaleNadderGUIProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity.m_6095_().m_204039_(TagKey.m_203882_(Registries.f_256939_, new ResourceLocation("how_to_own_a_dragon:male_nadder"))) && Screen.m_96638_()) {
            ItemStack var10000;
            ...
            if (var10000.m_41720_() == ItemStack.f_41583_.m_41720_() && sourceentity instanceof ServerPlayer) {
               ...
               NetworkHooks.openScreen(_ent, new MenuProvider() {
                  public Component m_5446_() {
                     return Component.m_237113_("NotGrownMaleNadderGUI");
                  }

                  public AbstractContainerMenu m_7208_(int id, Inventory inventory, Player player) {
                     return new NotGrownMaleNadderGUIMenu(id, inventory, (new FriendlyByteBuf(Unpooled.buffer())).m_130064_(_bpos));
                  }
               }, _bpos);
            }
         }
