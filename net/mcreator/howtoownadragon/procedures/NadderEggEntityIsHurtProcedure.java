         ...
         if (var10000.m_41720_() == ItemStack.f_41583_.m_41720_()) {
            ...
            if (entity.getPersistentData().m_128461_("naddercolor").equals("stormfly")) {
               ...
               if (sourceentity instanceof LivingEntity) {
                  ...
                  _setstack = new ItemStack((ItemLike)HowToOwnADragonModItems.NADDER_EGG_ITEM.get());
               ...
               HowToOwnADragonMod.queueServerWork(1, () -> {
                  ...
                  var10000.m_41784_().m_128359_("naddercolor", "stormfly");
               });
               ...
               HowToOwnADragonMod.queueServerWork(1, () -> {
                  ...
                  var10000.m_41784_().m_128359_("naddercolor", "red");
               });
               ...
               HowToOwnADragonMod.queueServerWork(1, () -> {
                  ...
                  var10000.m_41784_().m_128359_("naddercolor", "purple");
               });
            }
         }
