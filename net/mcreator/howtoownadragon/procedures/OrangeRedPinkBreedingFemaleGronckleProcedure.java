...
@EventBusSubscriber
public class OrangeRedPinkBreedingFemaleGronckleProcedure {
   @SubscribeEvent
         ...
         if (entity instanceof TamableAnimal) {
            ...
            if (sourceentity instanceof LivingEntity) {
               ...
               if (_tamIsTamedBy.m_21830_(_livEnt) && entity instanceof GronckleFemaleEntity && !world.m_6443_(GronckleMaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                  ...
                  })).compareDistOf(x, y, z)).findFirst().orElse((Object)null)).getPersistentData().m_128461_("groncklecolor").equals("pink") && entity.getPersistentData().m_128461_("groncklecolor").equals("orangered")) {
