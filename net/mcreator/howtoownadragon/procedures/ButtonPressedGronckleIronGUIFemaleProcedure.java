...
public class ButtonPressedGronckleIronGUIFemaleProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, final Entity entity) {
      if (entity != null) {
         Entity var9 = (Entity)world.m_6443_(GronckleFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 4.0D, 4.0D, 4.0D), (e) -> {
            return true;
            ...
            if (var10000.m_41720_() == ((Block)HowToOwnADragonModBlocks.LIMESTONE.get()).m_5456_()) {
               ...
               if (var10000.m_41720_() == Blocks.f_50062_.m_5456_()) {
                  ...
                  if (var10000.m_41720_() == Items.f_151050_) {
                     ...
                     Entity var25 = (Entity)world.m_6443_(GronckleFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 4.0D, 4.0D, 4.0D), (e) -> {
                        return true;
                     }).stream().sorted(((<undefinedtype>)(new Object() {
                        Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                           return Comparator.comparingDouble((_entcnd) -> {
