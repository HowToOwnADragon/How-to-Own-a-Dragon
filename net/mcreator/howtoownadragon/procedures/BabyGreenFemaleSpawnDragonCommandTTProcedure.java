...
public class BabyGreenFemaleSpawnDragonCommandTTProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      if (world instanceof ServerLevel) {
         ServerLevel _level = (ServerLevel)world;
         Entity entityToSpawn = new BabyTTFemaleEntity((EntityType)HowToOwnADragonModEntities.BABY_TT_FEMALE.get(), _level);
      ...
      Entity var11 = (Entity)world.m_6443_(BabyTTFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
         return true;
      ...
      if (var11 instanceof BabyTTFemaleEntity) {
         BabyTTFemaleEntity animatable = (BabyTTFemaleEntity)var11;
