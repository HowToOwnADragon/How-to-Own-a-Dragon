...
public class SpawningEggRightClickedEntityNadderProcedure {
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         ...
         if (((<undefinedtype>)(new Object() {
         ...
         })).checkGamemode(sourceentity) && entity.m_6095_().m_204039_(TagKey.m_203882_(Registries.f_256939_, new ResourceLocation("how_to_own_a_dragon:nadder")))) {
            ...
            if (var10000.m_41720_() == HowToOwnADragonModItems.SPAWN_EGG_NADDER.get()) {
            ...
            if (var10000.m_41720_() == HowToOwnADragonModItems.SPAWN_EGG_NADDER.get()) {
               if (sourceentity instanceof LivingEntity) {
                  ...
                  ItemStack _setstack = new ItemStack((ItemLike)HowToOwnADragonModItems.SPAWN_EGG_NADDER.get());
                  ItemStack var10001;
                  if (sourceentity instanceof LivingEntity) {
