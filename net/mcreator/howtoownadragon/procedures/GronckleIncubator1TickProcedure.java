...
public class GronckleIncubator1TickProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      })).getItemStack(world, BlockPos.m_274561_(x, y, z), 0).m_41784_().m_128461_("groncklecolor").equals("pink")) {
      ...
      })).getItemStack(world, BlockPos.m_274561_(x, y, z), 0).m_41784_().m_128461_("groncklecolor").equals("orangered")) {
         _ent = world.m_7702_(BlockPos.m_274561_(x, y, z));
         if (_ent != null) {
            _slotid = true;
            _setstack = ((<undefinedtype>)(new Object() {
      ...
      })).getItemStack(world, BlockPos.m_274561_(x, y, z), 0).m_41784_().m_128461_("groncklecolor").equals("blueyellow")) {
         _ent = world.m_7702_(BlockPos.m_274561_(x, y, z));
         if (_ent != null) {
            _slotid = true;
            _setstack = ((<undefinedtype>)(new Object() {
      ...
      })).getItemStack(world, BlockPos.m_274561_(x, y, z), 0).m_41784_().m_128461_("groncklecolor").equals("meatlug")) {
         _ent = world.m_7702_(BlockPos.m_274561_(x, y, z));
         if (_ent != null) {
            _slotid = true;
            _setstack = ((<undefinedtype>)(new Object() {
