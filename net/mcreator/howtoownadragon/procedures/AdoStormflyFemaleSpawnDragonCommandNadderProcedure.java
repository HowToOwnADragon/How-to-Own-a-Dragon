...
public class AdoStormflyFemaleSpawnDragonCommandNadderProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      Entity var11 = (Entity)world.m_6443_(AdolescentNadderFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
         return true;
      ...
      if (var11 instanceof AdolescentNadderFemaleEntity) {
         AdolescentNadderFemaleEntity animatable = (AdolescentNadderFemaleEntity)var11;
