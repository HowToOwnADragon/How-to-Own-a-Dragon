...
public class PinkItemNeededForGrowUpTTProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         ...
         Player _player;
         ItemStack var10001;
         if (entity.getPersistentData().m_128461_("ttgrowup").equals("bread")) {
            ...
            if (var10000.m_41720_() == Items.f_42406_) {
               ...
               PinkGrowUpProcedureTTProcedure.execute(world, x, y, z, entity, sourceentity);
               return;
            }
         }

         if (entity.getPersistentData().m_128461_("ttgrowup").equals("cod")) {
            if (sourceentity instanceof LivingEntity) {
               LivingEntity _livEnt = (LivingEntity)sourceentity;
               var10000 = _livEnt.m_21205_();
            } else {
         ...
         if (entity.getPersistentData().m_128461_("ttgrowup").equals("salmon")) {
            if (sourceentity instanceof LivingEntity) {
               LivingEntity _livEnt = (LivingEntity)sourceentity;
               var10000 = _livEnt.m_21205_();
            } else {
         ...
         if (entity.getPersistentData().m_128461_("ttgrowup").equals("chicken")) {
            if (sourceentity instanceof LivingEntity) {
               LivingEntity _livEnt = (LivingEntity)sourceentity;
               var10000 = _livEnt.m_21205_();
            } else {
