...
@EventBusSubscriber
public class StormflyAdoGrowUpFemaleNadderProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity.getPersistentData().m_128461_("naddercolor").equals("stormfly") && entity instanceof AdolescentNadderFemaleEntity) {
            StormflyItemNeededForGrowUpNadderProcedure.execute(world, x, y, z, entity, sourceentity);
         }
