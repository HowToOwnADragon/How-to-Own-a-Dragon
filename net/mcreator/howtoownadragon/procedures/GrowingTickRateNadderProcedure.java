...
public class GrowingTickRateNadderProcedure {
      ...
      if (entity != null) {
         ...
         HowToOwnADragonMod.queueServerWork(2, () -> {
            if (entity instanceof TamableAnimal) {
               ...
               Entity patt1257$temp = (Entity)world.m_6443_(Player.class, AABB.m_165882_(new Vec3(x, y, z), 4.0D, 4.0D, 4.0D), (e) -> {
                  return true;
               ...
               if (patt1257$temp instanceof Player) {
                  Player _owner = (Player)patt1257$temp;
