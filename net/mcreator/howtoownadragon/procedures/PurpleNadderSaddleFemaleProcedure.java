...
@EventBusSubscriber
public class PurpleNadderSaddleFemaleProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof NadderFemaleEntity && entity instanceof TamableAnimal) {
            ...
            if (_tamEnt.m_21824_()) {
               ...
               if (var10000.m_41720_() == HowToOwnADragonModItems.NADDER_SADDLE.get() && !entity.getPersistentData().m_128471_("naddersaddle") && entity.getPersistentData().m_128461_("naddercolor").equals("purple")) {
                  if (sourceentity instanceof LivingEntity) {
                  ...
                  if (entity instanceof NadderFemaleEntity) {
                     ...
                     animatable.setTexture("purplenaddersaddle");
                  }

                  entity.getPersistentData().m_128379_("naddersaddle", true);
               } else {
                  if (sourceentity instanceof LivingEntity) {
                     LivingEntity _livEnt = (LivingEntity)sourceentity;
                     var10000 = _livEnt.m_21205_();
                  ...
                  if (var10000.m_41720_() == HowToOwnADragonModItems.SADDLE_RACK.get() && entity.getPersistentData().m_128471_("naddersaddle") && entity.getPersistentData().m_128461_("naddercolor").equals("purple")) {
                     if (sourceentity instanceof LivingEntity) {
                        _entity = (LivingEntity)sourceentity;
                        _setstack = new ItemStack((ItemLike)HowToOwnADragonModItems.NADDER_SADDLE.get());
                        _setstack.m_41764_(1);
                        _entity.m_21008_(InteractionHand.MAIN_HAND, _setstack);
                        if (_entity instanceof Player) {
                           _player = (Player)_entity;
