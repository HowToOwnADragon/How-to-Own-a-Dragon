      ...
      if (entity != null && sourceentity != null) {
         if (entity instanceof TamableAnimal) {
            ...
            if (sourceentity instanceof LivingEntity) {
               ...
               if (_tamIsTamedBy.m_21830_(_livEnt) && entity.m_6095_().m_204039_(TagKey.m_203882_(Registries.f_256939_, new ResourceLocation("how_to_own_a_dragon:tt_not_grown")))) {
                  ItemStack var10000;
                  if (sourceentity instanceof LivingEntity) {
                     LivingEntity _livEnt = (LivingEntity)sourceentity;
