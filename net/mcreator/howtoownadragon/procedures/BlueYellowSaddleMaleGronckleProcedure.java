...
@EventBusSubscriber
public class BlueYellowSaddleMaleGronckleProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity instanceof GronckleMaleEntity && entity instanceof TamableAnimal) {
            ...
            if (_tamEnt.m_21824_()) {
               ...
               if (var10000.m_41720_() == HowToOwnADragonModItems.GRONCKLE_SADDLE.get() && !entity.getPersistentData().m_128471_("groncklesaddle") && entity.getPersistentData().m_128461_("groncklecolor").equals("blueyellow")) {
                  if (sourceentity instanceof LivingEntity) {
                  ...
                  if (var10000.m_41720_() == HowToOwnADragonModItems.SADDLE_RACK.get() && entity.getPersistentData().m_128471_("groncklesaddle") && entity.getPersistentData().m_128461_("groncklecolor").equals("blueyellow")) {
                     if (sourceentity instanceof LivingEntity) {
                        _entity = (LivingEntity)sourceentity;
