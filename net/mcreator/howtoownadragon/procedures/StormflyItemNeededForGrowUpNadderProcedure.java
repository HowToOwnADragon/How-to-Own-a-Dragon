...
public class StormflyItemNeededForGrowUpNadderProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         ...
         Player _player;
         ItemStack var10001;
         if (entity.getPersistentData().m_128461_("naddergrowup").equals("mutton")) {
            ...
            if (var10000.m_41720_() == Items.f_42658_) {
               ...
               StormflyGrowUpProcedureNadderProcedure.execute(world, x, y, z, entity, sourceentity);
               return;
            }
         }

         if (entity.getPersistentData().m_128461_("naddergrowup").equals("cod")) {
            if (sourceentity instanceof LivingEntity) {
               LivingEntity _livEnt = (LivingEntity)sourceentity;
               var10000 = _livEnt.m_21205_();
            } else {
         ...
         if (entity.getPersistentData().m_128461_("naddergrowup").equals("salmon")) {
            if (sourceentity instanceof LivingEntity) {
               LivingEntity _livEnt = (LivingEntity)sourceentity;
               var10000 = _livEnt.m_21205_();
            } else {
         ...
         if (entity.getPersistentData().m_128461_("naddergrowup").equals("chicken")) {
            if (sourceentity instanceof LivingEntity) {
               LivingEntity _livEnt = (LivingEntity)sourceentity;
               var10000 = _livEnt.m_21205_();
            } else {
