...
public class BabyGreenMaleSpawnDragonCommandTTProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      if (world instanceof ServerLevel) {
         ServerLevel _level = (ServerLevel)world;
         Entity entityToSpawn = new BabyTTMaleEntity((EntityType)HowToOwnADragonModEntities.BABY_TT_MALE.get(), _level);
      ...
      Entity var11 = (Entity)world.m_6443_(BabyTTMaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
         return true;
      ...
      if (var11 instanceof BabyTTMaleEntity) {
         BabyTTMaleEntity animatable = (BabyTTMaleEntity)var11;
