...
@EventBusSubscriber
public class StormflySaddleFemaleNadderProcedure {
   @SubscribeEvent
      ...
      if (entity != null && sourceentity != null) {
         if (entity instanceof NadderFemaleEntity && entity instanceof TamableAnimal) {
            ...
            if (_tamEnt.m_21824_()) {
               ...
               if (var10000.m_41720_() == HowToOwnADragonModItems.NADDER_SADDLE.get() && !entity.getPersistentData().m_128471_("naddersaddle") && entity.getPersistentData().m_128461_("naddercolor").equals("stormfly")) {
                  if (sourceentity instanceof LivingEntity) {
                  ...
                  if (var10000.m_41720_() == HowToOwnADragonModItems.SADDLE_RACK.get() && entity.getPersistentData().m_128471_("naddersaddle") && entity.getPersistentData().m_128461_("naddercolor").equals("stormfly")) {
                     if (sourceentity instanceof LivingEntity) {
                        _entity = (LivingEntity)sourceentity;
