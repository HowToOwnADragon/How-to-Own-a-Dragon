         ...
         if (Mth.m_216271_(RandomSource.m_216327_(), 1, 4) == 1) {
            ...
            if (var3 instanceof Player) {
               ...
               if (!_player.f_19853_.m_5776_()) {
                  _player.m_5661_(Component.m_237113_("Your " + entity.m_5446_().getString() + " is ready to grow up! It requires some sustenance. It needs some Bread!"), false);
               }
            }

            entity.getPersistentData().m_128359_("ttgrowup", "bread");
            ...
            entity.getPersistentData().m_128359_("ttgrowup", "cod");
            ...
            entity.getPersistentData().m_128359_("ttgrowup", "salmon");
            ...
            entity.getPersistentData().m_128359_("ttgrowup", "chicken");
         } else {
            execute(entity);
         }
