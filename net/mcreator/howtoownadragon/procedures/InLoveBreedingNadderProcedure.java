      ...
      if (entity != null && sourceentity != null) {
         if (entity instanceof TamableAnimal) {
            ...
            if (sourceentity instanceof LivingEntity) {
               ...
               if (_tamIsTamedBy.m_21830_(_livEnt) && entity.m_6095_().m_204039_(TagKey.m_203882_(Registries.f_256939_, new ResourceLocation("how_to_own_a_dragon:grown_nadder")))) {
                  ItemStack var10000;
                  if (sourceentity instanceof LivingEntity) {
                     LivingEntity _livEnt = (LivingEntity)sourceentity;
                  ...
                  if (var10000.m_41720_() == Items.f_42658_) {
                     ...
                     entity.getPersistentData().m_128379_("nadderinlove", true);
                  } else {
                     if (sourceentity instanceof LivingEntity) {
                        LivingEntity _livEnt = (LivingEntity)sourceentity;
                        var10000 = _livEnt.m_21205_();
