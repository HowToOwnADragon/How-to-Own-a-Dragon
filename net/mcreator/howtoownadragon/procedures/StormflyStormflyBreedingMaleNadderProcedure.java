...
@EventBusSubscriber
public class StormflyStormflyBreedingMaleNadderProcedure {
   @SubscribeEvent
      ...
      if (entity != null && sourceentity != null) {
         if (entity instanceof TamableAnimal) {
            ...
            if (sourceentity instanceof LivingEntity) {
               ...
               if (_tamIsTamedBy.m_21830_(_livEnt) && entity instanceof NadderMaleEntity && !world.m_6443_(NadderFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                  return true;
               }).isEmpty()) {
                  Entity var13 = (Entity)world.m_6443_(NadderFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                     return true;
                  ...
                  if (((Entity)world.m_6443_(NadderFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                     return true;
                  }).stream().sorted(((<undefinedtype>)(new Object() {
                     Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble((_entcnd) -> {
                  ...
                  })).compareDistOf(x, y, z)).findFirst().orElse((Object)null)).getPersistentData().m_128471_("nadderinlove") && ((Entity)world.m_6443_(NadderFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                     return true;
                  }).stream().sorted(((<undefinedtype>)(new Object() {
                     Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
                        return Comparator.comparingDouble((_entcnd) -> {
                  ...
                  })).compareDistOf(x, y, z)).findFirst().orElse((Object)null)).getPersistentData().m_128461_("naddercolor").equals("stormfly") && entity.getPersistentData().m_128461_("naddercolor").equals("stormfly")) {
                     ...
                     StormflyStormflyNadderBreedingReqProcedure.execute(world, x, y, z, sourceentity);
                  }
               }
            }
         }
