...
@EventBusSubscriber
public class PurpleAdoGrowUpFemaleNadderProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (entity.getPersistentData().m_128461_("naddercolor").equals("purple") && entity instanceof AdolescentNadderFemaleEntity) {
            PurpleItemNeededForGrowUpNadderProcedure.execute(world, x, y, z, entity, sourceentity);
         }
