         ...
         if (entity instanceof TamableAnimal) {
            ...
            if (sourceentity instanceof LivingEntity) {
               ...
               if (_tamIsTamedBy.m_21830_(_livEnt) && entity instanceof TTMaleEntity && !world.m_6443_(TTFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                  ...
                  if (((Entity)world.m_6443_(TTFemaleEntity.class, AABB.m_165882_(new Vec3(x, y, z), 10.0D, 10.0D, 10.0D), (e) -> {
                  ...
                  })).compareDistOf(x, y, z)).findFirst().orElse((Object)null)).getPersistentData().m_128461_("ttcolor").equals("green") && entity.getPersistentData().m_128461_("ttcolor").equals("green")) {
                     ...
                     GreenGreenTTBreedingReqProcedure.execute(world, x, y, z, sourceentity);
                  }
               }
            }
         }
